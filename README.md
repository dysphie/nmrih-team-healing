...
Blocks are saved to the database specified by the `sm_team_healing_block_database` convar. This must match the name of an entry in `sourcemod/configs/databases.cfg`
